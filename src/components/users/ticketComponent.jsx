...
export default function TicketComponent({ raffleData, tickets, purchase }) {
    ...
    return (
        <div className="ticketComponent">
            <svg className='iconHead' xmlns="http://www.w3.org/2000/svg" width="8rem" height="8rem" viewBox="0 0 24 24"><g fill="none" stroke="#A3A3A3" strokeWidth="2"><path strokeLinejoin="round" d="M18 21V3l-3 2l-3-2l-3 2l-3-2v18l3-1.5l3 1.5l3-1.5z" /><path strokeLinecap="round" d="M10 9h4m-4 6h4m-4-3h4" /></g></svg>
